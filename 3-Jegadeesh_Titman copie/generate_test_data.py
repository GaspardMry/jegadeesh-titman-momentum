# =============================================================================
# GÉNÉRATEUR DE DONNÉES DE TEST — Simule le fichier CRSP
#
# Ce script crée un fichier CSV "crsp_data_test.csv" avec la même structure
# que les vraies données CRSP (1965-1989).
#
# Quand tu auras le vrai fichier CSV, remplace simplement DATA_PATH dans
# momentum_strategy.py et ce script ne sera plus nécessaire.
# =============================================================================
...
N_SEMESTRES = 50     # de Semester=1 à Semester=50 (environ 25 ans)
